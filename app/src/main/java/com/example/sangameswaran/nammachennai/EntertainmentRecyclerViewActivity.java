...
public class EntertainmentRecyclerViewActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.entertainment_recycler_view_activity);
        recyclerView = (RecyclerView) findViewById(R.id.entertainmentrecyclerview);
        ...
        if (b < 0) {
            ...
            for (int i = b; i > 0; i--) {
                DatabaseReference myref = FirebaseDatabase.getInstance().getReference("EVENTS/ENTERTAINMENT/NAME/" + i);
