...
public class AwarenessRecyclerView extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.awareness_recycler_view);
        recyclerView = (RecyclerView) findViewById(R.id.awarenessrecyclerview);
        ...
        if (b < 0) {
            ...
            for (int i = b; i > 0; i--) {
                DatabaseReference myref = FirebaseDatabase.getInstance().getReference("EVENTS/AWARENESS/NAME/" + i);
