...
public class FitnessRecyclerViewActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.fitness_recycler_view);
        recyclerView=(RecyclerView)findViewById(R.id.fitnessrecyclerview);
        ...
        {
        for(int i=b;i>0;i--) {
            DatabaseReference myref = FirebaseDatabase.getInstance().getReference("EVENTS/FITNESS/NAME/" + i);
